<x-app-layout>
    ...
    <div x-data x-init="$nextTick(() => { $el.classList.add('show') })" class="page-transition">
        <x-container>
            <x-alert-status />
            <x-card class="tw-flex tw-flex-col">
                <div class="tw-flex tw-justify-center" id="banner-container">
                ...
                <div class="tw-flex tw-flex-row">
                    <div class="tw-flex-auto tw-w-3/4 tw-pr-5">
                        <div class="tw-justify-start">
                            <div class="tw-font-sans tw-font-semibold tw-text-xl tw-text-gray-900">{{ $event->title }}
                            </div>
                        </div>
                        ...
                        {{-- <div>
                            <div id="map" style="height: 50vh; min-width:50vw; margin-top: 0" class="tw-rounded-lg">
                            </div>
                        </div> --}}
                        ...
                        ">
                            <div id="map" style="margin-top: 0"
                                class="tw-rounded-lg tw-absolute tw-w-full tw-h-full tw-z-0"></div>
                        </div>
                    </div>
                    <div class="tw-flex-auto tw-w-1/4">
                        ...
                        <p class="tw-text-yellow-500">You have already registered for this event. Waiting for
                            acceptance.</p>
                        ...
                        <a href="{{ route('events.volunteers', $event) }}">
                            <x-primary-button
                                class="tw-flex-auto tw-w-full tw-bg-red-600 tw-justify-center hover:tw-bg-red-700">
                                List Volunteers
                            </x-primary-button>
                        </a>
                        <a href="{{ route('events.register', $event) }}">
                            <x-primary-button
                                class="tw-flex-auto tw-w-full tw-bg-red-600 tw-justify-center hover:tw-bg-red-700 mt-2">
                                List Registered
                            </x-primary-button>
                        </a>
                        @endcan
                        ...
                        <div class="tw-py-4 tw-flex tw-items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="tw-h-5 tw-w-5 tw-mr-2" fill="none"
                        ...
                        <div class="tw-divide-y tw-divide-gray-200">
                            ...
                            <div class="tw-py-3 tw-flex tw-justify-between">
                                ...
                                <div class="tw-flex tw-flex-col tw-items-end">
                                    ...
                                    <span class="tw-text-gray-500 tw-text-sm">{{ $review->created_at->format('Y-m-d')
                                        }}</span>
                                </div>
                                @else
                                <div></div>
