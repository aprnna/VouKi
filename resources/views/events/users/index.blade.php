    ...
    <x-container>
        ...
        <div class="tw-grid w-full tw-grid-cols-1 md:tw-grid-cols-2 tw-mb-8 tw-gap-5 tw-mt-8">
            @foreach ($events as $event)
                <a href="{{ route('organizer.show', $event->id) }}" class="tw-w-full tw-bg-white tw-flex tw-items-center tw-justify-center tw-cursor-pointer tw-rounded-lg tw-shadow tw-transition hover:tw-shadow-lg tw-duration-500 tw-ease-in-out hover:tw-scale-105">
                    <div class="w-full tw-flex tw-justify-between tw-p-4 tw-gap-2 tw-flex-wrap lg:tw-flex-nowrap">
                        <div class="tw-flex tw-gap-4 tw-items-center">
                            <img src="{{ asset('images/organizer_logo.png') }}" alt="{{ $event->name }}" class="tw-w-16 tw-rounded-full tw-h-16" />
