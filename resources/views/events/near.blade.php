<x-app-layout>
    ...
    <x-container class="tw-px-2 sm:tw-px-6">
        <div class="tw-opacity-0 tw-duration-500 tw-ease-in-out tw-delay-150">
            <div
                class="bg-white tw-w-full tw-flex tw-justify-between tw-items-center tw-shadow tw-p-2 tw-rounded tw-my-8">
                <x-dropdown align="left" width="80">
                    <x-slot name="trigger">
                        <div class="tw-flex tw-items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-funnel-fill tw-h-5"
                                viewBox="0 0 16 16">
                                <path
                    ...
                    <x-slot name="content">
                        <div class="tw-px-3 flex">
                            <div class="tw-w-full">
                                ...
                                <a href="{{ route('events.nearest', array_merge(request()->query(), ['category' => null]))}}"
                                ...
                                <a href="{{ route('events.nearest', array_merge(request()->query(),['category' => $category->id])) }}"
                                    class="tw-flex tw-items-center tw-py-2 tw-border tw-border-transparent tw-text-sm
                                            tw-leading-4 tw-font-medium tw-rounded-md tw-text-gray-500 tw-bg-white
                                            hover:tw-text-gray-900 focus:tw-outline-none tw-transition tw-ease-in-out tw-duration-150
                            ...
                            <div class="tw-w-full">
                                ...
                                <a href="{{ route('events.nearest', array_merge(request()->query(),['distance' => null])) }}"
                                    class="tw-flex tw-items-center tw-py-2 tw-border tw-border-transparent tw-text-sm
                                        tw-leading-4 tw-font-medium tw-rounded-md tw-text-gray-500 tw-bg-white
                                        hover:tw-text-gray-900 focus:tw-outline-none tw-transition tw-ease-in-out tw-duration-150
                                ...
                                <a href="{{ route('events.nearest', array_merge(request()->query(),['distance' => '10km'])) }}"
                                    class="tw-flex tw-items-center tw-py-2 tw-border tw-border-transparent tw-text-sm
                                        tw-leading-4 tw-font-medium tw-rounded-md tw-text-gray-500 tw-bg-white
                                        hover:tw-text-gray-900 focus:tw-outline-none tw-transition tw-ease-in-out tw-duration-150
                                ...
                                <a href="{{ route('events.nearest', array_merge(request()->query(),['distance' => '100km'])) }}"
                                    class="tw-flex tw-items-center tw-py-2 tw-border tw-border-transparent tw-text-sm
                                        tw-leading-4 tw-font-medium tw-rounded-md tw-text-gray-500 tw-bg-white
                                        hover:tw-text-gray-900 focus:tw-outline-none tw-transition tw-ease-in-out tw-duration-150
                                ...
                                <a href="{{ route('events.nearest', array_merge(request()->query(),['distance' => '1000km'])) }}"
                                    class="tw-flex tw-items-center tw-py-2 tw-border tw-border-transparent tw-text-sm
                                        tw-leading-4 tw-font-medium tw-rounded-md tw-text-gray-500 tw-bg-white
                                        hover:tw-text-gray-900 focus:tw-outline-none tw-transition tw-ease-in-out tw-duration-150
            ...
            <div class="tw-w-full tw-h-96 tw-flex tw-items-center tw-relative tw-justify-center tw-p-5 tw-rounded-lg tw-z-0 tw-mb-8
                ">
                <div id="map" style="margin-top: 0" class="tw-rounded-lg tw-absolute tw-w-full tw-h-full tw-z-0"></div>
            </div>
            ...
            <div
                class="tw-grid w-full tw-grid-cols-1 sm:tw-grid-cols-2 md:tw-grid-cols-3 lg:tw-grid-cols-4 tw-mb-8 tw-gap-5">
                ...
                <div
                    ...
                    <div class="tw-flex tw-flex-wrap tw-gap-2 tw-px-4 sm:tw-px-6">
                        ...
                        @endphp
                        <a href="{{ route('events.nearest', $categoryQuery) }}" class="tw-rounded-lg tw-px-2 tw-py-1 tw-text-xs tw-font-medium hover:tw-bg-gray-400 hover:tw-cursor-pointer tw-text-gray-800
                    ...
                    <div class="tw-flex tw-flex-wrap tw-gap-2 tw-px-4 sm:tw-px-6 tw-mt-2">
                        ...
                        @endphp
                        <a href="{{ route('events.nearest', $queryString) }}" class="tw-rounded-lg tw-px-2 tw-py-1 tw-text-xs tw-font-medium hover:tw-bg-gray-400 hover:tw-cursor-pointer tw-text-gray-800
