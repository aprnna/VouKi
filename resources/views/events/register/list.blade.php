      ...
      <x-card.header>
        ...
        <x-card.description>
          <div class="tw-sm:flex tw-sm:items-center">
            ...
            <a class="tw-text-tertiary1 hover:tw-text-secondary1 tw-text-sm"
              ...
              <tr
                ...
                <x-table.td>
                  <div class="tw-flex tw-items-center">
                    <div
                      class="tw-h-2.5 tw-w-2.5 tw-rounded-full {{ $status == 'accepted' ? 'tw-bg-green-500' : ($status == 'pending' ? 'tw-bg-yellow-500' : 'tw-bg-red-500')}}  tw-me-2">
                    </div> {{ ucfirst($status) }}
                  </div>
                </x-table.td>
