        ...
        <x-card.content>
          <x-table>
            ...
            <x-table.tbody>
              ...
              <tr>
                <x-table.td>
                  <a class="tw-text-indigo-600 hover:tw-text-indigo-900" href={{ Route('events.show', $event) }}>{{
                    $event->title }}</a>
                </x-table.td>
                ...
                <x-table.td>
                  @if ($event->status)
                  <a href={{ Route('events.edit', $event) }} class="tw-text-indigo-600 hover:tw-text-indigo-900">
                    Edit
                  </a>
                  ...
                  <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
                    <form method="post" action="{{ route('events.destroy', $event) }}" class="tw-p-6">
                      @csrf
                      @method('delete')
