...
<li class="tw-relative tw-w-full tw-mb-6">
  <div class="tw-flex tw-items-center">
    <div
      class="tw-z-10 tw-flex tw-items-center tw-justify-center tw-w-6 tw-h-6 tw-bg-tertiary1 tw-rounded-full tw-ring-0 tw-ring-white  sm:tw-ring-8  tw-shrink-0">
    ...
    @if(!$last)
    <div class="tw-flex tw-w-full tw-bg-secondary1 tw-h-0.5"></div>
    @endif
  </div>
  <div class="tw-mt-3">
