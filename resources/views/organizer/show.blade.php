        ...
        <div class="tw-flex tw-flex-col">
            <div class="tw-flex tw-items-center tw-gap-2">
                ...
                <div class="tw-flex tw-items-center tw-gap-1 tw-font-semibold tw-text-xl">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-star-fill tw-w-5 tw-text-yellow-400" viewBox="0 0 16 16">
            ...
            @forelse ( $organizer->events as $event )
                <x-card class="tw-flex tw-flex-col">
                    ...
                    <div class="tw-flex tw-flex-col tw-gap-2 tw-justify-end">
                        ...
                        <a href={{ route('events.show', $organizer->id) }}
                            class="tw-group tw-inline-flex tw-items-center justify-between tw-text-sm tw-font-medium tw-text-blue-600 tw-py-4">
